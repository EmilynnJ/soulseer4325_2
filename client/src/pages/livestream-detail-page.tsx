...
// Removed MuxPlayerErrorBoundary
              ...
              {!env.ENABLE_LIVESTREAMS ? (
                ...
                <div className="flex items-center justify-center bg-dark/50 h-full">
                  <div className="text-center p-8">
                    ...
                    <h3 className="text-xl font-cinzel text-secondary mb-2">Live Stream</h3>
                    <p className="text-light/70">
                      This stream is currently live. Video functionality has been temporarily disabled.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center bg-dark/50 h-full">
                  <div className="text-center p-8">
                    ...
                    <h3 className="text-xl font-cinzel text-secondary mb-2">Stream Recording</h3>
                    <p className="text-light/70">
                      This stream has ended. Recordings are temporarily unavailable.
                    </p>
                  </div>
                </div>
              ) : (
